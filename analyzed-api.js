...
*/
  ...
  var A = {},
    B = function () {
      if (A !== A) throw Error("SafeStyle is not meant to be built directly");
      this.s = "";
    };
  ...
  var fa = {},
    ha = function () {
      ...
      if (fa !== fa) throw Error("SafeHtml is not meant to be built directly");
      this.l = a;
    };
...
*/
 ...
 gapi.loader.OBJECT_CREATE_TEST_OVERRIDE &&*/
  var F = window,
    ...
    I = function () {
      var a;
      if ((a = Object.create) && ma.test(a)) a = a(null);
      else {
        a = {};
  ...
  var va = /^(\/[a-zA-Z0-9_\-]+)+$/,
      ...
      try {
        ...
        if (e && 0 < e.length) {
          ...
          for (d = {}; c < e.length; ) {
            ...
            k = typeof p;
            f =
              ("object" == k && null != p) || "function" == k
                ? "o" +
                  ((Object.prototype.hasOwnProperty.call(p, n) && p[n]) ||
                    (p[n] = ++da))
                : (typeof p).charAt(0) + p;
    ...
    Ea = function (a) {
      ...
      for (var b = a.substring(1).split("/"), c = []; b.length; ) {
        a = b.shift();
        if (!a.length || 0 == a.indexOf(".")) V("empty/relative directory");
        else if (0 < a.indexOf("=")) {
          b.unshift(a);
          break;
        }
      ...
      c = 0;
      for (d = wa.length; c < d; ++c) wa[c].test(b) && V("invalid_prefix");
      c = W(a, "k", !0);
      d = W(a, "am");
      e = W(a, "rs");
      a = W(a, "t");
  ...
  var X = decodeURI("%73cript"),
    ...
    Ja = function () {
      var a = K.nonce;
      return void 0 !== a
        ? a && a === String(a) && a.match(Ha)
          ? a
          : (K.nonce = null)
        : G.querySelector
        ? (a = G.querySelector("script[nonce]"))
    ...
    Ka = function (a) {
      ...
      b.async = "true";
      (a = G.getElementsByTagName(X)[0])
        ? a.parentNode.insertBefore(b, a)
        : (G.head || G.body || G.documentElement).appendChild(b);
    },
    Na = function (a, b, c) {
      Ma(function () {
    ...
    Pa = function (a, b) {
      ...
      if (!(a = c.h) && ((a = oa()), !a)) throw Error("Bad hint: !hint");
      Oa(b || [], c, a);
    },
    Oa = function (a, b, c) {
      var d = !!K.glrp;
